  ...
  return (
    <UserProvider>
      <Routes>
        ...
        <Route path="admin/*" element={isAuth ? <AdminLayout /> : <Navigate to="/auth/sign-in" replace />} />
        ...
        <Route
          path="/"
          element={isDemoRoute ? <Navigate to="/demo/dashboard" replace /> : isAuth ? <Navigate to="/admin" replace /> : <Navigate to="/auth/sign-in" replace />}
        />
      </Routes>
